...
- 변경된 contract 표면, 깨질 수 있는 caller/consumer 또는 배포 구간, 부족한 호환성 증거, adapter/fallback/versioning/migration 권고는 새 schema field를 만들지 말고 `body`, `recommendation`, `evidence`에 담는다.
