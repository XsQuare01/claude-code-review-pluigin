...
- 같은 폴더의 숫자 prefix 모듈(`00~13`)과 `fast.md`, `math.md`, `props.md`는 **참조하지 않는다**
...
이 문서 하나만 사용합니다. `~/.claude/review-rules/` 의 숫자 prefix 모듈(00~13), `fast.md`, `math.md`, `props.md`는 참조하지 마세요.
